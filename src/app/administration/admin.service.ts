...
export class AdminService {
  ...
  createDepartment(department: Department) {
    ...
    return this.httpClient.post(this.api + '/admin/payroll/department', body, { headers: headers });
  }
  ...
  updateDepartment(department: Department) {
    ...
    return this.httpClient.put(this.api + '/admin/payroll/department', body, { headers: headers, params: params });
  }
  deleteDepartment(param) {
    const headers = new HttpHeaders({ 'Content-Type': 'application/json' });
    const params = new HttpParams()
      .set('_id', param);
    return this.httpClient.delete(this.api + '/admin/payroll/department', { headers: headers, params: params });
  }
  clearDepartment() {
  ...
  createPosition(position: Position, id) {
    ...
    return this.httpClient.post(this.api + '/admin/payroll/position', body, { headers: headers, params: params });
  }
  updatePosition(positions: Position[]) {
    const body = JSON.stringify(positions);
    const headers = new HttpHeaders({ 'Content-Type': 'application/json' });
    return this.httpClient.put(this.api + '/admin/payroll/position', body, { headers: headers });
  }
  deletePosition(param) {
    const headers = new HttpHeaders({ 'Content-Type': 'application/json' });
    const params = new HttpParams()
      .set('_id', param);
    return this.httpClient.delete(this.api + '/admin/payroll/position', { headers: headers, params: params });
  }
  ...
  editUser(param): any {
    if (param) {
      ...
      const headers = new HttpHeaders({ 'Content-Type': 'application/json' });
      return this.httpClient.put(this.api + '/users/' + param._id, body, { headers: headers });
  ...
  saveClient(client: Client) {
    ...
    return this.httpClient.post(this.api + '/admin/employee/client', body, { headers: headers, params: params });
  }
  updateClient(client: Client) {
    const body = JSON.stringify(client);
    const headers = new HttpHeaders({ 'Content-Type': 'application/json' });
    const params = new HttpParams().set('id', client._id);
    return this.httpClient.put(this.api + '/admin/employee/client', body, { headers: headers, params: params });
  }
  ...
  saveShift(shift: any) {
    ...
    const headers = new HttpHeaders({ 'Content-Type': 'application/json' });
    return this.httpClient.post(this.api + '/admin/employee/shift', body, { headers: headers });
  }
  editShift(shift: any, id) {
    const body = JSON.stringify(shift);
    const headers = new HttpHeaders({ 'Content-Type': 'application/json' });
    const params = new HttpParams().set('id', id);
    return this.httpClient.put(this.api + '/admin/employee/shift', body, { headers: headers, params: params });
  }
  deleteShift(shift): any {
    const headers = new HttpHeaders({ 'Content-Type': 'application/json' });
    const params = new HttpParams()
      .set('_id', shift._id);
    return this.httpClient.delete(this.api + '/admin/employee/shift', { headers: headers, params: params });
  }
  clearShift() {
    this._shifts = null;
  }
  ...
  updateEmployee(employee: Employee) {
    ...
    return this.httpClient.put(this.api + '/admin/employee/update', body, { headers: headers, params: params });
  }
  deleteEmployee(employee: Employee) {
    ...
    return this.httpClient.delete(this.api + '/admin/employee/delete', { headers: headers, params: params });
  }
  ...
  getLogs(query) {
    ...
    const headers = new HttpHeaders({ 'Content-Type': 'application/json' });
    return this.httpClient.get(`${this.api}/logs/${_id}`, {headers: headers, params: params});
  }
  ...
  getUploads(query) {
    ...
    const headers = new HttpHeaders({ 'Content-Type': 'application/json' });
    return this.httpClient.get(`${this.api}/uploads/${_id}`, {headers: headers, params: params});
  }
  ...
  getHolidays(query) {
    ...
    const _id = 'q';
    const headers = new HttpHeaders({ 'Content-Type': 'application/json' });
    return this.httpClient.get(`${this.api}/admin/payroll/holidays/${_id}`, {headers: headers, params: params});
  }
  updateHolidays() {
  ...
  getIncomeTax(query) {
    ...
    const _id = 'q';
    const headers = new HttpHeaders({ 'Content-Type': 'application/json' });
    return this.httpClient.get(`${this.api}/admin/payroll/incomeTax/${_id}`, {headers: headers, params: params});
  }
  updateIncomeTax() {
