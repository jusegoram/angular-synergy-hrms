...
export class AdminService {
  ...
  deleteDepartment(param) {
    ...
    const params = new HttpParams()
      .set('_id', param);
    return this.httpClient.delete('/api/v1/admin/payroll/department', { headers: headers, params: params });
  }
  clearDepartment() {
  ...
  createPosition(position: Position, id) {
    ...
    return this.httpClient.post('/api/v1/admin/payroll/position', body, { headers: headers, params: params });
  }
  updatePosition(positions: Position[]) {
    const body = JSON.stringify(positions);
    const headers = new HttpHeaders({ 'Content-Type': 'application/json' });
    return this.httpClient.put('/api/v1/admin/payroll/position', body, { headers: headers });
  }
  deletePosition(param) {
    const headers = new HttpHeaders({ 'Content-Type': 'application/json' });
    const params = new HttpParams()
      .set('_id', param);
    return this.httpClient.delete('/api/v1/admin/payroll/position', { headers: headers, params: params });
  }
