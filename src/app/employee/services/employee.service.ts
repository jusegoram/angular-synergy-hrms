...
import {EmployeeCompany, EmployeePayroll, EmployeePersonal, EmployeePosition} from './models/employee-models';
...
export class EmployeeService {
  ...
  _employees: Observable<Array<IEmployee>> = null;
  _employeeStore: Observable<Array<any>> = null;
  ...
  // getEmployees() {
  //   return this.httpClient.get<Array<IEmployee>>(this.siteURI + '/employee/populateTable');
  // }

  getEmployees() {
      if (!this._employees) {
        this._employees = this.httpClient.get<Array<IEmployee>>(this.siteURI + '/employee/populateTable')
          .publishReplay(1)
          .refCount();
      }
    ...
    getDetails(param: string) {
      return this.httpClient.get<IEmployee>(this.siteURI + '/employee/main', {
    ...
    updateEmployee(employee: IEmployee) {
      ...
      return this.http.put(this.siteURI + '/employee/main?id=' + employee._id, body, {headers: headers})
