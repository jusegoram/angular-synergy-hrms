...
import { Employee, EmployeeFamily } from '../../employee.model';
...
export class FamilyComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, public snackBar: MatSnackBar, private employeeService: EmployeeService) {}
