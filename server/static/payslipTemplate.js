...
module.exports = ({
  ...
  return ejs.render(`
    ...
    * {
    ...
    <div id="payslip">
	<div id="title">Payslip for <%= element.employeeName %></div>
	<div id="scope">
		<div class="scope-entry">
			<div class="title">PAY RUN</div>
			<div class="value"><%= moment(element._id.payedDate).format('MMM DD, YYYY')%></div>
		</div>
		<div class="scope-entry">
			<div class="title">PAY PERIOD</div>
			<div class="value"><%= moment(element.payrolls[0].fromDate).format('MMM DD').toString()%> - <%= moment(element.payrolls[1].toDate).format('MMM DD, YYYY').toString()%></div>
		</div>
	</div>
	<div class="content">
